                ...
                if (response["data"] != null) {
                    ...
                    detailsTableBody = $("#Table_View").dataTable({
                        ...
                        columns: [
                            ...
                            {
                                data: 'mandatory', render: function (data) {
                                    return data == true ? 'Yes' : 'No'
                                },
                            },
                            {
...
$(document).on("click", '#btn_new', function () {
    ...
    $('#ck_active').iCheck('uncheck'); //To check the radio button

    $('#ck_mandatory').iCheck('update')[0].checked;
    $('#ck_mandatory').iCheck('uncheck'); //To check the radio button
    //discon();
});
...
$('table').on('click', '.btn-edit', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/TermsAndCondition/GetTermsAndConditionById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        if (!response["data"]["mandatory"]) {
                            $('#ck_mandatory').iCheck('uncheck');
                        } else { $('#ck_mandatory').iCheck('check'); }
                        imgload.hide();
                        imgloadsav.hide();
                        btnsav.hide();
                        btnupd.show();
...
function ckvalidation() {
    ...
    ck_mandatory = $("#ck_mandatory").iCheck('Update')[0].checked;
