...
var ComponentsDropdowns = function () {
    var handleSelect2 = function () {
        FillCountry();   //Fill Select 2 of Department
    }
    return {
...
function FillCountry() {
    $("#txt_Country").select2({
        ...
        ajax: { // instead of writing the function to execute the request we use Select2's convenient helper
            url: ApiForm + '/LOVServicesSales/GetCountry',
            type: "Get",
        ...
        initSelection: function (element, callback) {
            var data = { "id": _Country_Id, "text": _Country_Name };
            callback(data);
        },
...
$('#txt_Country').on("select2-selected", function (e) {
    _Country_Id = $("#txt_Country").select2('data').id;
});

$('#txt_Country').on("select2-removed", function (e) {
    _Country_Id = "0";
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        _Country_Id = response["data"]["countryId"];
                        _Country_Name = response["data"]["country"];
                        $('#txt_Country').val(_Country_Id); // Select the option with a value of '1'
                        $('#txt_Country').trigger('change'); // Notify any JS components that the value changed
