...
function viewGrid() {
    ...
    $.ajax({
        url: apiUrl + '/api/Payroll/v1/PayrollReport/SalaryRegisterWorker',
        type: "Post",
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                url: ApiForm + '/SalaryProcess/WorkerSalaryProcess',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
...
$(document).on("click", '#btn_salaryslipprint', function () {
    Swal.fire({
        ...
        if (result.value) {
            ...
            _cre = '{"dateFrom": "' + _dateFrom + '","dateTo":"' + _dateTo + '","officeWorker":"Worker"}';
            sessionStorage.setItem(sessid, _cre);
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                url: ApiForm + '/SalaryProcess/WorkerSalaryVoucherPost',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
