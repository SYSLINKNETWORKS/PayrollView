...
$(document).ready(function () {
    ApiForm = apiUrl + '/api/Payroll/v1/InOutEditorApproval';
    imgload.hide();
            ...
            if (response.statusCode == 200) {
                ...
                if (response["data"] != null) {
                    ...
                    detailsTableBody = $("#Table_View").dataTable({
                        data: response["data"]["inOutEditorGetApprovalSummaryModels"],
                        destroy: true,
                        retrieve: true,
                        paging: false,
                        search: false,
...
function updrec(_date, _approved) {
