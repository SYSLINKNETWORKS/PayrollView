...
$(document).ready(function () {
    ApiForm = apiUrl + '/api/Payroll/v1/LoanReceive';
    imgload.hide();
    imgloadsav.hide();
...
var ComponentsDropdowns = function () {
    var handleSelect2 = function () {
        ...
        FillLoan(); //Fill Select 2 of Loan
    }
...
function FillLoan() {
    $("#txt_Loan").select2({
        ...
        ajax: { // instead of writing the function to execute the request we use Select2's convenient helper
            url: apiUrl + '/api/Payroll/v1/LOVServicesPayroll/GetLoanforReceiving',
            type: "Get",
        ...
        initSelection: function (element, callback) {
            var data = { "id": _Loan_ID, "text": _Loan_Name };
            callback(data);
        },
...
$('#txt_employee').on("select2-selected", function (e) {
    _Loan_ID = $("#txt_employee").select2('data').id;
});
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        _Loan_ID = response["data"]["loanId"];
                        _Loan_Name = response["data"]["employeeName"]+ ' Installment Amount '+response["data"]["installmentAmount"] ;
                        $('#txt_Loan').val(_Loan_ID); // Select the option with a value of '1'
                        $('#txt_Loan').trigger('change'); // Notify any JS components that the value changed
