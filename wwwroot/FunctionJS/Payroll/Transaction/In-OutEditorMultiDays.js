                    ...
                    detailsTableBody = $("#Table_View").dataTable({
                        ...
                        columns: [
                            ...
                            },
                            {
                                data: 'date',
                                type: 'date',
                                render: function (data, type, row) { return moment(data).format('ddd DD/MMM/YYYY') }
                            },
                            {
                                data: 'rosterInn',
...
function ckvalidation() {
    ...
    for (var i = 0; i < rows_create.length; i++) {
        ...
        var txtdt = moment($(columns[1]).html()).format("YYYY-MM-DD");
