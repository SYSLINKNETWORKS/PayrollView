...
function Onload() {
    var tbl_row_cnt = 1;
    $.ajax({
        url: ApiForm + '/SalaryAdditionDeduction?_MenuId=' + _menuid,
        type: "Get",
        contentType: "application/json",
        dataType: "json",
...
function ckvalidation() {
    ...
    txtaddition = $('#txt_addition');
    txtdeduction = $("#txt_deduction");
   ...
   if (txtaddition.val() == '0' && txtdeduction.val() == '0') {
        ck = 1;
        _Error = "Addition or Deduction amount can't be zero";
    }
    ...
    if (Boolean(ck)) {
        ...
        _cre = JSON.stringify({
            ...
            "date": txtdate,
            "additionAmount": txtaddition.val(),
            "deductionAmount": txtdeduction.val(),
            "menu_Id": _menuid
        });
...
function savrec() {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: ApiForm + '/SalaryAdditionDeduction',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                data: _cre,
    ...
    Swal.fire({  
        ...
        if (result.value) {
            $.ajax({
                ...
                url: ApiForm + '/SalaryAdditionDeduction/GetSalaryAdditionDeductionById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        $('#txt_addition').val(response["data"]["additionAmount"]);
                        $('#txt_deduction').val(response["data"]["deductionAmount"]);
