...
function printReport() {
    detailsTable = $("#div_salaryregisterworker");
    detailsTable.empty();

    $.ajax({

        url: ApiForm + '/v1/PayrollReport/SalaryRegisterworker',
        type: "Post",
        ...
        success: function (response) {
            if (response.statusCode == 200) {
                ...
                rowdata += '<tr><th style="font-weight:bold;text-align:center;" colspan=22>Salary Register worker  Report</th></tr>';
                ...
                for (var row_cnt = 0; row_cnt < department.length; row_cnt++) {
                    ...
                    var _salary_amount = 0,
                        ...
                        _salary_addition = 0,
                        _employee_salary_worker_latedays_actual_amount = 0,
                        _salary_advance = 0,
                        _salary_loan = 0,
                        _salary_takaful = 0,
                        _salary_incometaxamount = 0,
                        _salary_deduction = 0,
                        _employee_salary_worker_amount_gross = 0,
                        _employee_salary_worker_overtime_actual_amount = 0,
                        _employee_salary_worker_amount_payable = 0
                        ;
                    ...
                    for (var row_cnt = 0; row_cnt < employee_1.length; row_cnt++) {
                        ...
                        _employee_salary_worker_latedays_actual_amount += parseFloat(employee_1[row_cnt]["lateDaysActualAmount"]);
                        ...
                        _employee_salary_worker_amount_gross += parseFloat(employee_1[row_cnt]["grossAmount"]);
                        _employee_salary_worker_overtime_actual_amount += parseFloat(employee_1[row_cnt]["overtimeActualAmount"]);
                        _employee_salary_worker_amount_payable += parseFloat(employee_1[row_cnt]["payableAmount"]);
                    ...
                    rowdata += '<tr style="font-weight:bold;">' +
                        ...
                        '<td>' + accounting.formatNumber(_employee_salary_worker_latedays_actual_amount) + '</td>' +
                        ...
                        '<td>' + accounting.formatNumber(_employee_salary_worker_amount_gross) + '</td>' +
                        '<td></td>' +
                        '<td>' + accounting.formatNumber(_employee_salary_worker_overtime_actual_amount) + '</td>' +
                        '<td>' + accounting.formatNumber(_employee_salary_worker_amount_payable) + '</td>';
