...
function printReport() {
    ...
    $.ajax({
        ...
        url: ApiForm + '/v1/PayrollReport/TimeSheet',
        type: "Post",
        ...
        success: function (response) {
            if (response.statusCode == 200) {
                ...
                rowdata += '<tr><th style="font-weight:bold;text-align:center;" colspan=21>Time Sheet Detail Report</th></tr>';
                ...
                for (var row_cnt = 0; row_cnt < employee.length; row_cnt++) {
                    ...
                    rowdata += '<tr>' +
                        ...
                        '<th style="text-align:Left;" colspan=11>' + employeeFilter[0]["employeeNo"] + '</th>' +
                    ...
                    rowdata += '<tr>' +
                        ...
                        '<th  style="text-align:Left;" colspan=11>' + employeeFilter[0]["employeeName"] + '</th>' +
