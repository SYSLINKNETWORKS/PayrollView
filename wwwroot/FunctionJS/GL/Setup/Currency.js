...
function Onload() {
    $.ajax({
        url:ApiForm+'/Currency',// apiUrl + '/api/Accounts/v1/BankAccount?_MenuId=' + _menuid,
        type: "Get",
...
$('table').on('click', '.btn-edit', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/Currency/GetCurrencyById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
...
$('table').on('click', '.btn-delete', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/Currency/DeleteCurrency',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                data: JSON.stringify({
