...
$("#txt_dr_amt").keyup(function (e) {
    if (e.keyCode === 13) {
        ...
        var productItem = '<tr><td><a data-itemId="0" href="#" class="deleteItem">Remove</a></td><td>' + account.select2('data').text + '</td><td>' + narration + '</td><td>' + accounting.formatNumber(debit, 2) + '</td><td hidden>' + account.select2('data').id + '</td></tr>';
        detailsTableBody.append(productItem);
        discon_det();
    }
});
...
function dgcal() {
    ...
    $("#txt_cr_amt").html(accounting.formatNumber(amt, 2));
}
...
function ckvalidation() {
    ...
    var txtAmountMaster = $("#txt_cr_amt").html();
    ...
    detail_record.push({
        ...
        "debitAmount": 0,
        "creditAmount": accounting.unformat(txtAmountMaster),
    })
    for (var i = 0; i < rows_create.length; i++) {
        columns = $(rows_create[i]).find('td');
        detail_record.push({
