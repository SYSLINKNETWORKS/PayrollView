...
function printReport() {
    ...
    detailsTable.empty();
    $.ajax({
        url: ApiForm + '/v1/PurchaseReport/PurchaseRequisitionSummaryReport',
        type: "Post",
            ...
            if (response.statusCode == 200) {
                ...
                for (var row_cnt = 0; row_cnt < _FilterData.length; row_cnt++) {
                    ...
                    rowdata += '<tr>' +
                        ...
                        '<td >' + moment(_FilterData[row_cnt]["deliveryDate"]).format("DD-MMM-YYYY")  + '</td>' +
                        ...
                        '<td> ' + accounting.format(_FilterData[row_cnt]["orderQty"],0) + '</td>' +
