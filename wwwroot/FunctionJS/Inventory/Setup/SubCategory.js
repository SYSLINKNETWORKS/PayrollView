...
var ComponentsDropdowns = function () {
    var handleSelect2 = function () {
        ...
        FillCategory()      //Fill Select 2 of Item Category
    }
    return {
...
function FillCategory() {
    $("#txt_category").select2({
        ...
        allowClear: true,
        ajax: { // instead of writing the function to execute the request we use Select2's convenient helper
            url: ApiForm + '/LOVServicesItem/GetItemSubCategoryMaster',
            type: "Get",
            contentType: "application/json",
            dataType: "json",
            transport: function (params) {
...
$('table').on('click', '.btn-edit', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/ItemSubCategory/GetItemSubCategoryById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        _Category_ID = response["data"]["subCategoryMasterId"];
                        _Category_Name = response["data"]["subCategoryMasterName"];
...
function ckvalidation() {
    ...
    var txtdepartment = $('#txt_department');
    ...
    if (Boolean(ck)) {
        ...
        _cre = JSON.stringify({
            "ID": txtid,
            "name": txtname.val(),
            "subCategoryMasterId": _Category_ID,
