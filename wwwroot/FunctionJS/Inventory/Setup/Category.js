                        ...
                        columns: [
                            ...
                            { data: 'name' },
                            {
                                ...
                                "render": function (data, type, full, meta) {
                                    if (data == 'F') { return 'Finish Goods'; }
                                    else if (data == 'P') { return 'Raw Material'; }
                                    else if (data == 'G') { return 'Packing Material'; }
                                    else if (data == 'O') { return 'Others'; }
                                    else if (data == 'E') { return 'Semi Finish'; }
                                }
                            },
                            {
...
$('table').on('click', '.btn-edit', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/ItemCategory/GetItemCategoryById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        $('#S_type').val(response["data"]["categoryType"]);
