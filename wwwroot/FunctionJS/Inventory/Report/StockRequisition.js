...
function printReport() {
    ...
    detailsTable.empty();
    $.ajax({
        url: ApiForm + '/v1/Report/GetRequisitionInventory',
        type: "Post",
        ...
        success: function (response) {
            if (response.statusCode == 200) {
                ...
                const qoutno_1 = response["data"]["requisitionInventoryMasters"];
                ...
                for (var row_cnt = 0; row_cnt < qouno.length; row_cnt++) {
                    const _transaction = response["data"]["requisitionInventoryMasters"].filter(d => d.id == qouno[row_cnt]["_id"]);
                    var _columnno = 10;
                    ...
                    rowdata += '</thead>';
                    var Detailsrecord = _transaction[0]["requisitionInventoryDetails"];
