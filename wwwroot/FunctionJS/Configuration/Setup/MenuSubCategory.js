...
var ComponentsDropdowns = function () {
    var handleSelect2 = function () {
        FillCategory(); //Fill Select 2 of Menu Category
    }
    return {
...
function FillCategory() {
    $("#txt_cat").select2({
        ...
        ajax: { // instead of writing the function to execute the request we use Select2's convenient helper
            url: ApiForm + '/LOVServices/GetMenuCategories',
            type: "Get",
        ...
        initSelection: function (element, callback) {
            var data = { "id": CategoryId, "text": CategoryName };
            callback(data);
        },
...
$('#txt_cat').on("select2-selected", function (e) {
    CategoryId = $("#txt_cat").select2('data').id;
});
...
function Onload() {
    var tbl_row_cnt = 1;
    $.ajax({
        url: ApiForm + '/UserMenuSubCategory?_MenuId=' + _menuid,
        type: "Get",
        contentType: "application/json",
        dataType: "json",
...
function savrec() {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: ApiForm + '/UserMenuSubCategory',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                data:_cre,
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                ...
                url: ApiForm + '/UserMenuSubCategory/GetUserMenuSubCategoryById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    if (response.statusCode == 200) {
                        ...
                        $('#txt_cat').val(CategoryId); 
                        $('#txt_cat').trigger('change'); 
...
function ckvalidation() {
    ...
    if (txtIcon.val() == '') {
        ck = 1;
        _Error = 'Please Enter Suitable Icon';
        txtIcon.focus();
    }

    //Set Category where FillCategory is Ending
