...
function Onload() {
    var tbl_row_cnt = 1;
    $.ajax({
        url: ApiForm + '/UserMenuCategory?_MenuId=' + _menuid,
        type: "Get",
...
function savrec() {
    ...
    Swal.fire({
        ...
        if (result.value) {
            var txtname = $('#txt_nam').val();
            var txticon = $('#txt_icon').val();
            ckActive = $('#ck_act').iCheck('update')[0].checked;
            $.ajax({
                url: ApiForm + '/UserMenuCategory',
                type: "Post",
                contentType: "application/json",
                dataType: "json",
                data:_cre,
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                ...
                url: ApiForm + '/UserMenuCategory/GetUserMenuCategoryById',
                type: "Get",
                contentType: "application/json",
                dataType: "json",
                beforeSend: function (xhr) {
                ...
                success: function (response) {
                    ...
                    if (response.statusCode == 200) {
                        ...
                        $('#txt_icon').val(response["data"]["icon"]);
